			...
			<aside
				...
				<div class="ui-block-weahter">
					...
					<div class="widget w-weather">
						<img src="/resources/img/BlogUser.png"
					...
					<div class="wethear-now inline-items">
						<div class="max-min-temperature"></div>
					</div>
				</div>

				<div class="ui-block">
					<div id="calendar2" class="crumina-full-calendar"></div>
					<script src="/resources/js/libs/fullcalendar.min.js"></script>
				</div>
			</aside>
		</div>
	...
	<div id="eventModal" class="modal">
		<div class="modal-content">
			...
			<form id="eventForm" method="post">
				<!-- 일정 ID hidden 필드 -->
				<input class="form-control" type="hidden" name="eventId"
					id="eventId">

				<!-- 일정 제목 입력 -->
				<div class="form-group">
					<label for="eventTitle">일정 제목</label> <input class="form-control"
						type="text" name="eventTitle" id="eventTitle"
						placeholder="일정 제목을 입력하세요" required>
				</div>

				<!-- 일정 날짜 입력 -->
				<div class="form-group">
					<label for="eventDate">일정 날짜</label> <input class="form-control"
						type="date" name="eventDate" id="eventDate" required>
				</div>
...
<script src="https://cdn.jsdelivr.net/npm/@fullcalendar/daygrid@4.3.1/main.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@fullcalendar/interaction@4.3.1/main.min.js"></script>
