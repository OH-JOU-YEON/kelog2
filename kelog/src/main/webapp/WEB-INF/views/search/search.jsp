...
<head>
	...
	<!-- Main RTL CSS -->
	<!--<link rel="stylesheet" type="text/css" href="/resources/css/rtl.min.css">-->
...
<div class="container mt-4">
  ...
  <div class="mb-3">
    ...
    <hr class="my-1">
    <p class="text-secondary fs-6 mt-2 mb-0"><c:out value="${searchResult.length}"/> </p>
  </div>
    ...
    <c:forEach var="searchResult" items="${searchResults}">
      ...
      <div class="ui-block p-3 mb-3">
        <div class="d-flex">
          ...
          <div>
            <h5 class="title fw-bold"><c:out value="${searchResult.title}"/></h5>
            <p class="mb-0"><c:out value="${searchResult.preview}"/> </p>
          </div>
        </div>
      </div>
