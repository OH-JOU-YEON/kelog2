...
<body class="body-bg-white">
	...
	<div class="stunning-header bg-primary-opacity" style="height: 500px;">
		...
		<div class="stunning-header-content">
			...
			<ul class="breadcrumbs">
				<li class="breadcrumbs-item active"><span>다양한 꿀팁들을 한번에!</span>
				</li>
			</ul>
		</div>
	...
	<form id="fom" action="/tip/created" method="post">
		<div class="row" style="justify-content: center;">
			<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="form-group">
					<input name="email" class="material-input form-control"
						type="hidden" value="${email}"> <label>Title</label> <input
						name="title" id="title" class="material-input form-control"
						placeholder="제목 입력" type="text">
				</div>
				<!-- 해시태그 -->
				<div class="mb-3">
		...
		<div class="row" style="justify-content: center;">
			<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="form-group">
					<label>nickName</label> <input readonly="readonly" id="nickName"
		...
		<div class="row" style="justify-content: center;">
			<button type="button" id="submitBtn" class="btn btn-primary btn-md-2"
				style="margin-right: 200px; width: 100px; height: 30px;">등록</button>
			<a href="/tip/list" class="btn btn-primary btn-md-2"
				style="width: 100px; height: 30px;">취소</a>
		</div>
	</form>
