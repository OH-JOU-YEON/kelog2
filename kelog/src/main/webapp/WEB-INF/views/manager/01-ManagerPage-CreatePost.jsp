			...
			<div class="registration-login-form">
				...
				<div class="tab-content" id="registration-form-tabs-content">
					<div class="tab-pane fade show active">
									...
									<div class="col col-lg-6 col-md-6 col-sm-12 col-12" >
										<div class="admin-container">
											<div class="tabs" style="display: flex; justify-content: flex-end; gap: 10px;">
													<a href="#" class="btn btn-primary btn-md-2" id="tab-mypage">마이페이지</a>
										...
										<div class="form-group">
											<input class="form-control" placeholder="제목 입력" type="text">
							...
							<div class="row" style="justify-content: center;">
							<button class="btn btn-primary btn-md-2" style="margin-right: 200px; width: 100px; height: 30px;">등록</button>
							<button class="btn btn-primary btn-md-2" style="width: 100px; height: 30px;">취소</button>
							</div>
							</form>    
					</div>
			</div>
